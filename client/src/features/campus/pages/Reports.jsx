        ...
        <div>
            ...
            <div className="grid grid-cols-3 gap-3 p-2 rounded-2xl bg-gray-200 mb-5">
                {[
                    ...
                    <div
                        key={key}
                        className={`py-2 sm:py-3 px-2 sm:px-4 md:px-6 rounded-xl text-sm sm:text-base md:text-lg flex gap-2 sm:gap-3 items-center justify-center cursor-pointer transition-all duration-300 ${activeTab === key ? 'bg-white text-black' : 'text-gray-700'
                            }`}
