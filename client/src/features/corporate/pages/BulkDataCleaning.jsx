        ...
        <div className="p-4 sm:p-6 md:p-8 bg-[#ede7f6] rounded-[12px] min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 mb-4 sm:mb-5">
                <div className="rounded-[12px] p-4 sm:p-5 shadow-md flex-1 bg-[#fff]">
                    <h3 className="text-[#4A148C] text-base sm:text-lg font-semibold mb-2">Processing Dataset</h3>
                    <p className="text-xs sm:text-sm mb-2">Clean duplicate records</p>
                    <button
                ...
                <div className="rounded-[12px] p-4 sm:p-5 shadow-md flex-1 bg-[#fff]">
                    <h3 className="text-[#4A148C] text-base sm:text-lg font-semibold mb-2">Upload New Data</h3>
                ...
                <div className="rounded-[12px] p-4 sm:p-5 shadow-md flex-1 bg-[#fff]">
                    <h3 className="text-[#4A148C] text-base sm:text-lg font-semibold mb-2">Missing Records</h3>
            ...
            <div className="p-3 sm:p-4 md:p-5 rounded-[12px] shadow-md mb-4 sm:mb-5 bg-[#fff]">
                ...
                <ul className="list-none p-0 m-0 text-sm sm:text-base">
                    ...
                    <ul className="ml-4 sm:ml-5">
                        <li className="py-2 border-b border-[#eee]">Company Name - {stats.missing.company_name || 0}</li>
                        <li className="py-2 border-b border-[#eee]">Location - {stats.missing.location || 0}</li>
                        <li className="py-2 border-b border-[#eee]">Job Title - {stats.missing.job_title || 0}</li>
                        <li className="py-2 border-b border-[#eee]">Address - {stats.missing.address || 0}</li>
                        <li className="py-2 border-b border-[#eee]">Phone Number - {stats.missing.phone_number || 0}</li>
                        <li className="py-2 border-b border-[#eee]">Website Link - {stats.missing.website_link || 0}</li>
                    </ul>
                </ul>
            </div>
        </div>
