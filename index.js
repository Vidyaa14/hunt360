...
// ✅ Memory storage for Vercel (no disk writes)
    ...
    if (website === "Collegedunia") {
      ...
      try {
        ...
        for (const row of rows) {
          try {
            let college_name, course_fees, placement, ranking, address, phone;
            if (row.tag === "tr") {
            ...
            data.push([fileName, college_name, course_fees, placement, ranking, correctedCourse, correctedState, city, address, phone]);
