...
import { getCompanyYearTrends, getAnalytics, getYearlyTrends } from '../controllers/analytics.controller.js';
import { getDashboard, getUpcomingMeetings } from '../controllers/dashboard.controller.js';
import { cleanDuplicates, deleteRecord, getDataStats, getPreviousScrapes, saveForm, searchCompanies, searchMarketingData, uploadFile } from '../controllers/data.controller.js';
import {
    getBdComparison, getCommunicationStatusOverview,
    getLatestCommunication,
    getLeadStatusDistribution,
    getLocationWiseLeadCount, getReportSummary, getStateWiseBdActivities
